...
const DICT = {
  it: {
    ...
    'grid.note': 'Il tuo punto {reqLat}, {reqLon} · cella di previsione più vicina {gLat}, {gLon}',
    ...
    'spots.loading': 'Cerco i punti nei dintorni e ne valuto l’affaccio verso il sole…',
    ...
    'explain.highFew.detail': 'Mancano i cirri che accendono il cielo: colori più sobri.',
    ...
    'spot.dualLegend': 'numero grande = qualità dell’affaccio · “cielo” = colore previsto lì',
    'spot.estTag': 'STIM',
    'unit.m': 'm',
    'unit.km': 'km',
    'unit.min': 'min',
  ...
  en: {
    ...
    'grid.note': 'Your point {reqLat}, {reqLon} · nearest forecast cell {gLat}, {gLon}',
    ...
    'spots.loading': 'Finding nearby spots and checking their view towards the sun…',
    ...
    'banner.top': '{noun} alert: {day} {score}/100 — the best of the coming days',
    ...
    'spot.dualLegend': 'big number = view quality · “sky” = expected colour there',
    'spot.estTag': 'EST',
    'unit.m': 'm',
    'unit.km': 'km',
    'unit.min': 'min',
