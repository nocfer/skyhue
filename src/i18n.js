...
const DICT = {
  it: {
    ...
    'why.sub': '{n} cose giocano a favore di stasera.',
    'why.subOne': 'Una cosa gioca a favore di stasera.',
  ...
  en: {
    ...
    'why.sub': "{n} things line up in tonight's favour.",
    'why.subOne': "One thing lines up in tonight's favour.",
